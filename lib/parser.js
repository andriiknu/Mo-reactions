...
(function () {
  ...
  function renderFromX4(x4, opts={}){
    ...
    Plotly.newPlot('chart', traces, {
      ...
      xaxis: { title: { text: 'Incident Energy (MeV)', standoff: config.x_label_offset }, showgrid: true, gridcolor: 'rgba(0,0,0,.08)', zeroline: false },
      yaxis: { title: { text: 'Cross section (barns)', standoff: config.y_label_offset }, showgrid: true, gridcolor: 'rgba(0,0,0,.08)', zeroline: false },
      legend:{
        orientation: 'v',
